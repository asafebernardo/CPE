...
import { Box, Button, Alert, List, ListItem, ListItemText, Grid } from '@mui/material';
...
export function ManagementPage() {
  ...
  return (
    <Box>
      <PageHeader title="Backup & Restore" subtitle="Save and restore device configuration snapshots." />
